...
public class MyDataBase_Unimind {
    ...
    final String URL = "jdbc:mysql://localhost:3306/unimind_db?useUnicode=true&characterEncoding=UTF-8&autoReconnect=true&failOverReadOnly=false&maxReconnects=10";
    ...
    public Connection getConnection() {
        try {
            ...
            try {
                ...
                System.err.println("Reconnexion impossible: " + ex.getMessage());
            }
        }
        return connection;
    }
