...
public class SidebarEtudiantController {
    ...
    public void setParentController(BaseDashboardController controller) {
        ...
        System.out.println("SidebarEtudiantController.setParentController() - Parent reçu");
    ...
    private User getUtilisateur() {
        User user = parentController != null ? parentController.getUtilisateurConnecte() : null;
        System.out.println("SidebarEtudiantController.getUtilisateur() - user: " + (user != null ? user.getPrenom() : "null"));
        return user;
    }
    ...
    private void afficherInfosSidebar() {
        ...
        if (sidebarNomLabel != null && user != null) {
            ...
            sidebarRoleLabel.setText("Étudiant");
        }
    }
    ...
    public void ouvrirProfil() {
        User user = getUtilisateur();
        System.out.println("SidebarEtudiantController.ouvrirProfil() - user: " + (user != null ? user.getPrenom() : "null"));
